		...
		<div class="card">
			...
			<div class="card-body">
				<table class="table table-bordered text-center" >					
					...
					<tr onclick="OpenWindow('detail.do?nno=${notice.nno}','상세보기','800','900');" style='font-size:0.85em;cursor:pointer;'>
						<td>${notice.nno }</td>
						<td id="boardTitle" style="text-align:left; max-width: 100px; overflow: hidden;
											white-space: nowrap; text-overflow: ellipsis;">
											${notice.title }
											</td><!--글이 길어지면 뒤에....나오게하는것  -->
						<td data-taget="notice-writer">${notice.writer }</td>
...
<script>
    window.onload=function(){
       $("[data-taget='notice-writer']").click(function(event){
